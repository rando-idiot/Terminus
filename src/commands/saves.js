...
function toJson(obj) {
  ...
  let result = obj.class
    ? "{"
    : `{"class":"${Object.getPrototypeOf(obj).constructor.name}",`;
...
function deserializeOnto(obj, src) {
  ...
  if (!(typeof obj === "object"))
    return console.warn("TODO: Non object types", obj);
  ...
  if (constructor.name !== obj.class)
    console.warn(
      "Saved data prototypes don't match, data may be corrupted.\nGot:",
      constructor.name,
      obj.class
    );
